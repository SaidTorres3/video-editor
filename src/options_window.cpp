...
// Win32 window functions are no longer used - UI is handled by imgui_ui.cpp
void ShowOptionsWindow(HWND) {}
LRESULT CALLBACK OptionsProc(HWND hwnd, UINT msg, WPARAM, LPARAM) { return DefWindowProc(hwnd, msg, 0, 0); }
void ShowUploadWindow(HWND) {}
LRESULT CALLBACK UploadProc(HWND hwnd, UINT msg, WPARAM, LPARAM) { return DefWindowProc(hwnd, msg, 0, 0); }
void ShowB2ConfigWindow(HWND) {}
LRESULT CALLBACK B2ConfigProc(HWND hwnd, UINT msg, WPARAM, LPARAM) { return DefWindowProc(hwnd, msg, 0, 0); }
void ShowCatboxConfigWindow(HWND) {}
LRESULT CALLBACK CatboxConfigProc(HWND hwnd, UINT msg, WPARAM, LPARAM) { return DefWindowProc(hwnd, msg, 0, 0); }
