...
- **Interactive Crop**: Hold the left mouse button and drag on the video preview to draw a selection rectangle. Release to apply the crop. Right-click or use the **Clear Crop** button to reset.
